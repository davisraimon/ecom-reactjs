      ...
      <div className="main-header-container">
        ...
        <div className="header-navs">
          {navData.map((nav, key) => (
            <>
              <div
                onClick={() => this.redirectTo(nav.link)}
                className={
                  this.state.focus == nav.name
              ...
              >
                ...
                >
                  {navMenuData[nav.name].map((item) => (
                    <div style={{ marginRight: 8 }}>
                      <div className="nav-sub-link-header">
                        {item.displayname}
                      </div>
                      {item.subcategories.map((subcategory) => (
                        <div
                          onClick={() => this.redirectTo(subcategory.link)}
        ...
        {this.state.subcategoryLink != "" ? (
          <Redirect to={"/shop/" + this.state.subcategoryLink}></Redirect>
        ) : null}
